...
module.exports = function(logger){
    ...
    app.get('/get_page', cors({origin: '*'}), function(req, res, next){
    ...
    app.get('/key.html', cors({origin: '*'}), function(req, res, next){
    ...
    app.use(compress());
    app.get('/workers/:address', cors({origin: '*'}), minerpage);
    app.get('/:page', cors({origin: '*'}), route);
    app.get('/', cors({origin: '*'}), route);

    app.get('/api/:method', cors({origin: '*'}), function(req, res, next){
        portalApi.handleApiRequest(req, res, next);
    });

    app.post('/api/admin/:method', cors({origin: '*'}), function(req, res, next){
